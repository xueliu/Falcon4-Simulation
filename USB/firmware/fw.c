...
//	SYNCDELAY;
//	IOC|=0x00; //output 1 on PC.0...SYNC signal is LOW 
//	SYNCDELAY;
//	OEC|=0x02; //PC.1 as output (SYNC signal)
//	SYNCDELAY;
//	IOC|=0x00; //output 1 on PC.1...SYNC signal is LOW 
//	SYNCDELAY;
//	OEC|=0x04; //PC.2 as output (SYNC signal)
//	SYNCDELAY;
//	IOC|=0x00; //output 1 on PC.2...SYNC signal is LOW
//	SYNCDELAY;

//	OEA|=0xEF; //Declare PA.7 as input
//	SYNCDELAY;
