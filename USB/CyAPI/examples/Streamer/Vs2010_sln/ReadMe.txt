...
Please note that the source code for the Visual Studio 2008 and 2010 projects is not common due to known issue in the GUI resource file(the icon file in VS2010 reaise exception so we have commented code specific to the Icon drawing).
