...
namespace Streamer
{
    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        */
        ...
        {
            USBDevice dev = usbDevices[0x0547, 0x1004];
        ...
        */
        private void PpxBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            long ppx = Convert.ToUInt16(PpxBox.Text);
            long len = EndPoint.MaxPktSize * ppx;

            int maxLen = 0x100001; // 1M
            if (len > maxLen)
            {
                ppx = maxLen / EndPoint.MaxPktSize / 8 * 8;
                PpxBox.Text = ppx.ToString();
                MessageBox.Show("Maximum of 1024KB per transfer.  Packets reduced.", "Invalid Packets per Xfer.");
            }
